...
//you have to initialize global variables with some null/empty values
    ...
    public void googleSearch() throws InterruptedException {
        ...
        Thread.sleep(3000);
        //enter a keyword
        ReusableMethods.sendKeysMethod(driver,"//*[@name='q']","cars","Google Search Field");
        //submit on google search button
        ReusableMethods.Submit(driver,"//*[@name='btnK']");
        Thread.sleep(2500);
    ...
    public void captureSearchNumber(){
        String result = ReusableMethods.captureText(driver,"//*[@id='result-stats']",0,"Google Search Results");
